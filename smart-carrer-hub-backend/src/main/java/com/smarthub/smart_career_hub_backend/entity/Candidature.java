...
@NoArgsConstructor
@AllArgsConstructor
@ToString(exclude = { "chercheurEmploi", "offre" })
@EqualsAndHashCode(exclude = { "chercheurEmploi", "offre" })
...
public class Candidature {
    ...
    private Offre offre;
    // Maps a Java enum to a database column."is to store the status of the
    // application"
